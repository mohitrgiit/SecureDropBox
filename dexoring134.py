...
# xoring to get r4,5,6,7,8,9 if server 1,3,4 is available and server 2 is down.
def xor_s134_1(input1, input2):
	...
	str2 = file2.read()
        ...
        # r1 ^ r19 = r9
	if(input1.endswith("R1") and input2.endswith("R19")):
	...
	# r3 ^ r37 = r7
		...
		print "Xoring done " + filename
	# r7 ^ r67 = r6
	if(input1.endswith("R7") and input2.endswith("R67")):
                filename = input1.replace("R7","R6")
         	print filename
		r6 = sxor(str1,str2)
		file3 = open(filename, "w")
		file3.write(r6)
		print "Xoring done " + filename
	# r6 ^ r26 = r2
        elif(input1.endswith("R6") and input2.endswith("R26")):
                filename = input1.replace("R6","R2")
         	print filename
		r2 = sxor(str1,str2)
		file3 = open(filename, "w")
		file3.write(r2)
		print "Xoring done " + filename
	# r2 ^ r25 = r5
	elif(input1.endswith("R2") and input2.endswith("R25")):
		...
		print "Xoring done " + filename
       	# r5 ^ r45 = r4
	elif(input1.endswith("R5") and input2.endswith("R45")):
...
def main():
	...
	for files in os.listdir("."):
        ...
        for p in L3: 
          for q in L_Rij:
               if(p.endswith("R7") and (q.endswith("R67"))):
                       xor_s134_1(p,q)
	#L3: Stores generated random files 
	for files in os.listdir("."):
		for i in range(9):
        ...
        for p in L3: 
          for q in L_Rij:
	       if(p.endswith("R6") and (q.endswith("R26"))):
                       xor_s134_1(p,q)
	#L3: Stores generated random files 
	for files in os.listdir("."):
		for i in range(9):
