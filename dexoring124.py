...
def xor_s124_1(input1, input2):
	...
	# r2 ^ r25 = r5
		...
		print "Xoring done " + filename
	# r9 ^ r89 = r8
	if(input1.endswith("R9") and input2.endswith("R89")):
		...
		print "Xoring done " + filename
	# r8 ^ r38 = r3
        elif(input1.endswith("R8") and input2.endswith("R38")):
                filename = input1.replace("R8","R3")
         	print filename
		r3 = sxor(str1,str2)
		file3 = open(filename, "w")
		file3.write(r3)
	...
	# r3 ^ r37 = r7
		...
		print "Xoring done " + filename
	# r7 ^ r67 = r6
	elif(input1.endswith("R7") and input2.endswith("R67")):
...
def main():
	...
	for files in os.listdir("."):
        ...
        for p in L3: 
          for q in L_Rij:
	       if(p.endswith("R8") and (q.endswith("R38"))):
                       xor_s124_1(p,q)
